...
class Box extends Component {
    ...
    render() {
        ...
        return (
            ...
            <div className={this.props.iconsize===1 || this.props.iconsize===2 ? `col-sm-10 card-inner h-100 mt-1`: `col-sm-10 card-inner h-100 mt-1`}
            ...
            >
                <div className={this.props.backactive === "black" ? `hover-effect1 w-100 d-flex align-items-center`:
                    `hover-effect w-100 d-flex align-items-center`}>
                    ...
                    <div>
                        <h4 className={` cursor-pointer ${this.props.fontsize}size mb-0`}
                            onClick={() => { this.props.addTabs(this.props.box.fparam) }}
                        >{this.props.box.name}</h4>
                        <p className={`${this.props.fontsize}size`} style={{fontSize:"12px"}}>
